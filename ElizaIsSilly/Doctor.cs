...
namespace ElizaIsSilly
{
    class Doctor
    {
        ...
        static Random randomLine = new Random();
        ...
        public static string Response(string userInput)
        {
            ...
            for (int index = 0; index < matches.Count; index++)
            {
                ...
                if (position > -1)
                {
                    ...
                    string remove = userInput.Remove(0, position + match.Length);
                    ...
                    remove = String.Join(" ", words);

                    // Strip leading and trailing spaces.
                    remainder = remove.Trim();

                    int randomIndex = randomLine.Next(0, responses[index].Count);
            ...
            if (output == "")
            {
                int randomIndex = randomLine.Next(0, responses[responses.Count - 1].Count);
